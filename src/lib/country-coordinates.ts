// Country geographic center coordinates (latitude, longitude)
...
export const COUNTRY_COORDINATES: Record<string, { lat: number; lon: number }> = {
  ...
  'CRI': { lat: 9.75, lon: -83.75 },
  'CIV': { lat: 7.54, lon: -5.55 },
  'HRV': { lat: 45.10, lon: 15.20 },
  'CUB': { lat: 21.52, lon: -77.78 },
  'CYP': { lat: 35.13, lon: 33.43 },
  'CZE': { lat: 49.82, lon: 15.47 },
  'DNK': { lat: 56.26, lon: 9.50 },
  'DJI': { lat: 11.83, lon: 42.59 },
  'DMA': { lat: 15.41, lon: -61.37 },
  ...
  'EST': { lat: 58.60, lon: 25.01 },
  'ETH': { lat: 9.15, lon: 40.49 },
  'FJI': { lat: -17.71, lon: 178.07 },
  'FIN': { lat: 61.92, lon: 25.75 },
  ...
  'SVK': { lat: 48.67, lon: 19.70 },
  'SVN': { lat: 46.15, lon: 14.99 },
  'SOM': { lat: 5.15, lon: 46.20 },
  'ZAF': { lat: -30.56, lon: 22.94 },
  'SSD': { lat: 6.88, lon: 31.31 },
  'ESP': { lat: 40.46, lon: -3.75 },
  'LKA': { lat: 7.87, lon: 80.77 },
  'SDN': { lat: 12.86, lon: 30.22 },
  'SUR': { lat: 3.92, lon: -56.03 },
  'SWZ': { lat: -26.52, lon: 31.47 },
  'SWE': { lat: 60.13, lon: 18.64 },
  'CHE': { lat: 46.82, lon: 8.23 },
  ...
  'NCL': { lat: -20.90, lon: 165.62 },
  'MNP': { lat: 17.33, lon: 145.38 },
  'VAT': { lat: 41.90, lon: 12.45 },
  'ESH': { lat: 24.22, lon: -12.89 },
};
