// Country ISO2 codes for flag URLs
// Maps ISO3 codes to ISO2 codes for flag APIs
...
export const ISO3_TO_ISO2: Record<string, string> = {
  ...
  'QAT': 'QA', 'ROU': 'RO', 'RUS': 'RU', 'RWA': 'RW', 'LCA': 'LC',
  'WSM': 'WS', 'SMR': 'SM', 'STP': 'ST', 'SAU': 'SA', 'SEN': 'SN',
  'SRB': 'RS', 'SYC': 'SC', 'SLE': 'SL', 'SGP': 'SG', 'SVK': 'SK',
  'SVN': 'SI', 'SOM': 'SO', 'ZAF': 'ZA', 'SSD': 'SS', 'ESP': 'ES',
  'LKA': 'LK', 'SDN': 'SD', 'SUR': 'SR', 'SWZ': 'SZ', 'SWE': 'SE',
  'CHE': 'CH', 'SYR': 'SY', 'TJK': 'TJ', 'TZA': 'TZ', 'THA': 'TH',
  ...
  'PSE': 'PS', 'NCL': 'NC', 'MNP': 'MP', 'VAT': 'VA', 'ESH': 'EH',
};
